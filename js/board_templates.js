            ...
            <div class="overlay__edit--selections">
                ...
                <div class="edit__group">
                    ...
                    <div class="edit__wrapper-priority">
                        <button type="button" class="edit__button-prio edit__button-prio--urgent" onclick="setPriority('urgent')">
                            <span>Urgent</span>
                        ...
                        <button type="button" class="edit__button-prio edit__button-prio--medium" onclick="setPriority('medium')">
                            <span>Medium</span>
                        ...
                        <button type="button" class="edit__button-prio edit__button-prio--low" onclick="setPriority('low')">
                            <span>Low</span>
                            <svg width="20" height="14.51" viewBox="0 0 21 16" xmlns="http://www.w3.org/2000/svg">
