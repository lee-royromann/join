            ...
            <div class="overlay__edit--selections">
                ...
                <div class="edit__group">
                    ...
                    <div class="edit__wrapper-priority">
                        <button type="button" class="edit__button-prio" onclick="setPriority('urgent')">
                            <span>Urgent</span>
                        ...
                        <button type="button" class="edit__button-prio" onclick="setPriority('medium')">
                            <span>Medium</span>
                        ...
                        <button type="button" class="edit__button-prio" onclick="setPriority('low')">
                            <span>Low</span>
