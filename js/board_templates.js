...
<<<<<<< HEAD
                        <button type="button" class="edit__button-prio" id="edit__btn-urgent" onclick="setEditPriority('urgent')">
=======
...
<<<<<<< HEAD
                        <button type="button" class="edit__button-prio" id="edit__btn-medium" onclick="setEditPriority('medium')">
=======
...
<<<<<<< HEAD
                        <button type="button" class="edit__button-prio" id="edit__btn-low" onclick="setEditPriority('low')">
=======
