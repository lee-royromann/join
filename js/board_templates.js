            ...
            <div class="overlay__edit--selections">
                ...
                <div class="edit__group">
                    ...
                    <div class="edit__wrapper-priority">
                        <button type="button" class="edit__button-prio" id="edit__btn-urgent" onclick="setPriority('urgent')">
                            <span>Urgent</span>
                        ...
                        <button type="button" class="edit__button-prio" id="edit__btn-medium" onclick="setPriority('medium')">
                            <span>Medium</span>
                        ...
                        <button type="button" class="edit__button-prio" id="edit__btn-low" onclick="setPriority('low')">
                            <span>Low</span>
